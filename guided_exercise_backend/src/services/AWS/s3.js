...
export async function uploadVideoToS3(bucketName, key, filePath) {
    try {
        ...
        const fileStream = fs.createReadStream('C:/Users/grace/All Programming/ai-guided-exercise/guided_exercise_backend/src/services/AWS/testvideo30sec.mp4');
        if (!fileStream) {
...
export async function getVideoFromS3(bucketName, key) {
    try {
