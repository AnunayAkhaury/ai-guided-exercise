...
import { helloWorldController, createProfileController, getProfileController, getUserRecordingsController } from '@/controllers/firebase-controller.js';
...
import { getRecordingPlaybackController, listRecordingsBySessionController, listRecordingsByUserController, upsertRecordingController } from '@/controllers/recording-controller.js';
import { createSessionController, endSessionController, getSessionByIdController, joinSessionByCodeController, leaveSessionParticipantController, listSessionParticipantsController, listSessionsController, startSessionController, upsertSessionParticipantController } from '@/controllers/session-controller.js';
const router = Router();
